...
def dff(clk, rst, q, d):
    ...
    hs_out = handshake_out(q, q_hs_en, q_hs_done)
...
dff_conf = {'interfaces': {'q': ifconf.handshake.Handshake(Signal(intbv(0)[DW:])), 'd': ifconf.direct.BitVector(DW), 'clk': ifconf.direct.BitSingle(), 'rst': ifconf.direct.BitSingle()}}
